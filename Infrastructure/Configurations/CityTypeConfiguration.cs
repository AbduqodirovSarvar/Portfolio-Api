...
namespace Infrastructure.Configurations
{
    public class CityTypeConfiguration : LocalizableEntityTypeConfiguration<City>
    {
        ...
        public static readonly List<City> UzbekistanCities = [
            new City
                {
                    CountyId = CountryTypeConfiguration.Countries[0].Id,
                    Name = "Tashkent",
                    NameUz = "Toshkent",
                    NameEn = "Tashkent",
                    NameRu = "Ташкент"
        ...
        private static readonly List<City> KazakhstanCities = [
            new City
                {
                    CountyId= CountryTypeConfiguration.Countries[1].Id,
                    Name = "Almaty",
                    NameUz = "Almaty",
                    NameEn = "Almaty",
                    NameRu = "Алматы"
